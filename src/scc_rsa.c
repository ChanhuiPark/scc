...
int SC_RSA_Rsaes_Oaep_Encrypt(SC_RSA_PublicKey *key, int mode, const U8 *label, U32 label_len, U32 ilen, const U8 *input, U8 *output)
{
	...
	if(SC_Bigint_Bitlen(key->n) != 2048 && SC_Bigint_Bitlen(key->n) != 3072) {
    ...
    *p++ = 0;
    ...
    // Construct DB
    //
	SC_SHA256_Digest(p, &p_len, label, label_len);
    p += hlen;
...
{
	U8 p[] = {};
...
{
	U8 q[] = {0xA6,0x42,0xBB,0x70,0xA8,0xF4,0xE4,0x51, 0x78,0x58,0xB9,0x71,0x29,0x26,0x12,0xA4, 
	          0x20,0x39,0x4B,0x1D,0xAF,0x03,0x48,0xFE, 0xC5,0xF2,0x42,0x03,0x2A,0x3E,0xB6,0x69};
...
{
	U8 g[] = {};
...
{
	U8 y[] = {};
